                ...
                if (typeof settings === "object") {
                    ...
                    function initialize(dataSource) {
                        var refreshHandler = function () {
                            updatePager(dataSource.getTotalEntityCount());
                        };
                        dataSource.bind("refreshSuccess", refreshHandler);
                        ...
                        function setPage(newPageNumber, refresh) {
                            ...
                            dataSource.setPaging({ skip: pageNumber * pageSize, take: pageSize, includeTotalCount: true });
                            if (refresh) {
                                dataSource.refresh();
                            }
                            updatePager();
                        ...
                        function destroy() {
                            if (refreshHandler) {
                                dataSource.unbind("refreshSuccess", refreshHandler);
